...
const NAV_HOGAR = [
  ...
  { label: 'Simular', icon: '🔬', route: '/hogar/simulador' },
...
export default function BottomNav({ tipo }: Props) {
  ...
  const items = tipo === 'hogar' ? NAV_HOGAR : tipo === 'estudiante' ? NAV_ESTUDIANTE : NAV_EMPRESA
...
const styles = StyleSheet.create({
  nav: { flexDirection: 'row', justifyContent: 'space-around', paddingVertical: 12, paddingBottom: 24, borderTopWidth: 1, borderTopColor: 'rgba(0,0,0,0.06)', backgroundColor: '#fff' },
